...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/account-stats", s.mgmt.GetAccountStats)
		mgmt.GET("/account-pricing", s.mgmt.GetAccountPricing)
		mgmt.PUT("/account-pricing", s.mgmt.PutAccountPricing)
		mgmt.PUT("/account-pricing/:id", s.mgmt.PutAccountPricing)
		mgmt.DELETE("/account-pricing/:id", s.mgmt.DeleteAccountPricing)
		mgmt.GET("/pricing/status", s.mgmt.GetPricingStatus)
		mgmt.GET("/pricing/models", s.mgmt.GetPricingModels)
		mgmt.POST("/pricing/sync", s.mgmt.PostPricingSync)
