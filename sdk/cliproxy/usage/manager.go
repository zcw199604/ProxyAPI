...
type Record struct {
	// EventID uniquely identifies one provider attempt. It is generated by the
	// usage manager when omitted, allowing durable sinks to de-duplicate retries.
	EventID  string
	Provider string
...
// UnregisterNamed removes a named plugin. It is safe to call for an unknown name.
